...
import com.julizey.moreplugins.commands.executors.ExecutionInfo;
import com.julizey.moreplugins.commands.executors.ExecutorType;
import com.julizey.moreplugins.commands.executors.NormalExecutor;
...
public class Executor<
  S extends CommandSender,
  W extends AbstractCommandSender<? extends CommandSender>
> {
  ...
  public static Executor<CommandSender, AbstractCommandSender<? extends CommandSender>> getInstance() {
    if (instance == null) instance =
      new Executor<CommandSender, AbstractCommandSender<? extends CommandSender>>();
    return instance;
  }
  ...
  Executor<S, W> mergeExecutor(Executor<S, W> executor) {
    ...
    result.normalExecutors =
      new ArrayList<NormalExecutor<S, W>>(normalExecutors);
