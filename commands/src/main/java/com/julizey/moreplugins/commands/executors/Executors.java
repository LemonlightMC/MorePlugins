...
import com.julizey.moreplugins.commands.Senders.BukkitBlockCommandSender;
import com.julizey.moreplugins.commands.Senders.BukkitCommandSender;
import com.julizey.moreplugins.commands.Senders.BukkitConsoleCommandSender;
import com.julizey.moreplugins.commands.Senders.BukkitEntity;
import com.julizey.moreplugins.commands.Senders.BukkitFeedbackForwardingCommandSender;
import com.julizey.moreplugins.commands.Senders.BukkitPlayer;
import com.julizey.moreplugins.commands.Senders.BukkitRemoteConsoleCommandSender;
...
public class Executors {
  ...
  public interface CommandBlockExecutor
    ...
    @Override
    default void run(
      final ExecutionInfo<BlockCommandSender, BukkitBlockCommandSender> info
    ) throws CommandException {
  ...
  public interface CommandBlockExecutionInfo
     ...
     *
     * @param info The ExecutionInfo for this command
     * @throws CommandException if an error occurs during the execution of this command
     */
  ...
  public interface CommandExecutionInfo
     ...
     */
    void run(
      ExecutionInfo<CommandSender, BukkitCommandSender<? extends CommandSender>> info
    ) throws CommandException;
  ...
  public interface CommandExecutor
    ...
    @Override
    default void run(
      final ExecutionInfo<CommandSender, BukkitCommandSender<? extends CommandSender>> info
    ) throws CommandException {
      this.run(info.sender(), info.args());
    }
  ...
  public interface ConsoleCommandExecutor
    ...
    @Override
    default void run(
      final ExecutionInfo<ConsoleCommandSender, BukkitConsoleCommandSender> info
    ) throws CommandException {
      this.run(info.sender(), info.args());
    }
  ...
  public interface ConsoleExecutionInfo
     ...
     */
    void run(
      ExecutionInfo<ConsoleCommandSender, BukkitConsoleCommandSender> info
    ) throws CommandException;
  ...
  public interface RemoteConsoleExecutionInfo
     ...
     */
    void run(
      ExecutionInfo<RemoteConsoleCommandSender, BukkitRemoteConsoleCommandSender> info
    ) throws CommandException;
