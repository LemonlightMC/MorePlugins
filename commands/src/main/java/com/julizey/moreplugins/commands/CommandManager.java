...
import com.julizey.moreplugins.commandbase.SimpleCommand;
import com.julizey.moreplugins.commands.executors.InternalExecutor;
  ...
  public static void unregister(SimpleCommand command) {
    ...
    try {
      ...
      while (iterator.hasNext()) {
        ...
        if (
          cmd instanceof InternalExecutor &&
