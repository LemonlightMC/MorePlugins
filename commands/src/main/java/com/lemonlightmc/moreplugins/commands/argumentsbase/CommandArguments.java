 ...
 * @param argsMap   The arguments for this command mapped to their node names.
 *                  This is an ordered map
 * @param args      The raw arguments for this command.
 * @param argsMap   The raw arguments for this command mapped to their node
 *                  names. This is an ordered map
